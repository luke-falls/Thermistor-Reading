...
module ADC_DelSig_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("617f3049-7c9f-4c41-9aea-8130f2c6cf7e/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("617f3049-7c9f-4c41-9aea-8130f2c6cf7e/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("4398a268-a2f2-4808-a62c-0218762391b9/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("5e5f044c-3ca5-48eb-9c80-35128c851818"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("908ab583-6fb9-478f-b855-3af0b2166ded"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8f72481f-932e-4c90-a469-9160890bf315"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f74a26e3-70b7-4c0f-add6-246b142ae679"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d217a19c-f05d-430e-b724-728a34e1247b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 PWR_12V (
        .connect({
            Net_114
        })
    );
    defparam PWR_12V.comp_name = "Power_v1_0";
    defparam PWR_12V.port_names = "T1";
    defparam PWR_12V.width = 1;

    cy_annotation_universal_v1_0 Pressure_Transducer_1 (
        .connect({
            Net_115,
            Net_114
        })
    );
    defparam Pressure_Transducer_1.comp_name = "Thermistor_v1_0";
    defparam Pressure_Transducer_1.port_names = "T1, T2";
    defparam Pressure_Transducer_1.width = 2;
